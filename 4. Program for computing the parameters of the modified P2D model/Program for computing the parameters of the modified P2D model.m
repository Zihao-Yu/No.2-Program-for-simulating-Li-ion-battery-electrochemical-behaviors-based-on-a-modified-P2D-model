...
parpool('Threads',threadprocessnumberset);  %Line 3-Line 4: Choose the parallel environment for computing the parameters of the modified P2D model and set the process number or thread number for computing the parameters of the modified P2D model.
format long;
...
E21=[0.3,0.7];
E22=[0.3,0.7];
E23=[0.0,0.2];  %Line 7-Line 29: Set the 23-dimensional space for searching for the values of the parameters of the modified P2D model.
aset=5;
bset=40;
cset=400;
dset=20;
...
tchange=0.5;
pset=-15;
qset=-15;  %Line 30-Line 39: Set the values of the parameters of the algorithms for computing the parameters and outputs of the modified P2D model.
xset=bset/threadprocessnumberset;
IL1=readmatrix('C:\Users\于子豪\Desktop\2\6. Data\Load current 1(average).xlsx','Sheet',1,'Range','C2:C401');
IL2=readmatrix('C:\Users\于子豪\Desktop\2\6. Data\Load current 1(instantaneous).xlsx','Sheet',1,'Range','B2:B402');
Vm=readmatrix('C:\Users\于子豪\Desktop\2\6. Data\Inter-electrode potential 1.xlsx','Sheet',1,'Range','B2:B402');
tlength=readmatrix('C:\Users\于子豪\Desktop\2\6. Data\Inter-electrode potential 1.xlsx','Sheet',1,'Range','A402:A402');  %Line 41-Line 44: Load the average Li-ion battery load current, instantaneous Li-ion battery load current and Li-ion battery inter-electrode potential for computing the parameters of the modified P2D model and the time length of the average Li-ion battery load current, instantaneous Li-ion battery load current and Li-ion battery inter-electrode potential for computing the parameters of the modified P2D model.
a=1;
while a<=aset
  EE1=zeros(1,xset);
  EE2=zeros(1,xset);
  ...
  EE21=zeros(1,xset);
  EE22=zeros(1,xset);
  EE23=zeros(1,xset);  %Line 47-Line 69: Let the set for storing (e1, e2, …, e23) on each process or thread be an empty set.
  spmd
    x=1;
    while x<=xset
      ...
      e23=min(E23)+(max(E23)-min(E23))*rand;  %Line 73-Line 95: Let (e1, e2, …, e23) be a random point in the 23-dimensional space for searching for the values of the parameters of the modified P2D model.
      ...
      end  %Line 96-Line 120: Narrow the 23-dimensional space for searching for the parameters of the modified P2D model and let (e1, e2, …, e23) be a random point in the 23-dimensional space for searching for the values of the parameters of the modified P2D model.
      ...
      while t<=tlength-tchange
        ...
        Vc(n+2,1)=ocp+phi+eta+zeta;
        t=t+tchange;
        n=n+1;
      end  %Line 121-Line 163: Compute Li-ion battery inter-electrode potential.
      c=1;
      d=1;
      while c<=cset
      ...
      end  %Line 164-Line 323: Let (e1, e2, …, e23) approach the values of the parameters of the modified P2D model.
      EE1(1,x)=e1;
      EE2(1,x)=e2;
      EE3(1,x)=e3;
      EE4(1,x)=e4;
      ...
      EE21(1,x)=e21;
      EE22(1,x)=e22;
      EE23(1,x)=e23;  %Line 324-Line 346: Store (e1, e2, …, e23) the set for storing (e1, e2, …, e23) on each process or thread.
      x=x+1;
    end
  end
  E1=gather(EE1);
  ...
  E22=[E22{:}];
  E23=[E23{:}];
  E=[E1;E2;E3;E4;E5;E6;E7;E8;E9;E10;E11;E12;E13;E14;E15;E16;E17;E18;E19;E20;E21;E22;E23];  %Line 350-Line 396: Gather the set for storing (e1, e2, …, e23) on each process or thread.  
  writematrix(E,'C:\Users\于子豪\Desktop\2\6. Data\Parameters 1.xlsx','Sheet',1,'Range','A1:AN23');  %Line 397: Store the computed parameters of the modified P2D model in Excel. 
  a=a+1;
end
delete(gcp('nocreate'));  %Line 400: Shut down the parallel pool for computing the parameters of the modified P2D model.